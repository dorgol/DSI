...
Community detection and graph partitioning are two related approaches to diving a network into meaningful sub-groups. In the latter, the number and size of groups is generally set beforehand, and the goal is to minimize edges between groups. Community detection has the more generally stated goal, to "find the natural fault lines" (@newman10). What exactly that means varies by method.
